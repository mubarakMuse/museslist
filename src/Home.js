        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="flex items-center mb-4 lg:mb-0">
            <img
              ...
              alt="BaseFinds" // Provide an alt text for accessibility
              className="h-12 w-12 mr-2" // Adjust the height and width as needed
            />
            <div className="text-2xl text-black font-bold">BaseFinds</div>
          </div>
          <div className="mt-4 text-black lg:mt-0">
            <p>&copy; {new Date().getFullYear()} BaseFinds. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
